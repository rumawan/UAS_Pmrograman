...
<html lang="en">
  ...
  <body id="page-top">
	...
	$anggota = query("SELECT * FROM dosen");
 ...
 ?>
                    ...
                    <h1>Daftar Dosen</h1>
                    <div class="tambah">
                        <a href="tambahdos.php">Tambah Dosen</a>
                    </div>
                    <br>
                    ...
                    <table border="1" cellpadding="10" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="ubahdos.php?nidn=<?php echo $row["nidn"]; ?>" class="btn btn-primary"">
                                    edit
                                </a> |
                                <a href="hapusdos.php?nidn=<?php echo $row["nidn"]; ?>"
