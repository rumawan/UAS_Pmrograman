...
<html lang="en">
  ...
  <body id="page-top">
	...
	$anggota = query("SELECT * FROM mahasiswa");
 ...
 ?>
                    ...
                    <table border="1" cellpadding="10" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="ubah.php?nim=<?php echo $row["nim"]; ?>" class="btn btn-primary">
                                    Edit
                                </a> |
                                <a href="hapus.php?nim=<?php echo $row["nim"]; ?>" class="btn btn-danger"
